...
Finally, to establish the accuracy of PocketParker we invited participants
...
equipped with fish-eye lenses served took \num{34138} time lapse images each
minute, time-stamped them using NTP, and uploaded them to a central server.

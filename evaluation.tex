...
\caption{\textbf{Missed Events.} The 80\% users of PocketPorker misses around 
20\% parking events.}
...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{./figures/Distance_Parking_Location.pdf}

\caption{\textbf{Distance between Arrival and Departure Location.} }

\label{fig-distanceofevents}
\end{figure*}
...
\caption{\textbf{Accuracy predictions for various kind of lots.} }
\label{fig-accuracy}
\end{figure}

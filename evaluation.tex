...
faithfully: 80\% of users missed less than 25\% parking events, because 
PocketParker has transition time threshold of 5 minutes. Therefore, 
PocketParker requires a minimum of 5 minutes to detect an user transition events

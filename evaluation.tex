...
require additional smoothing techniques or incorporating information from
other lots. However, as we demonstrate later, our availability estimator is
quite robust to errors in the monitored fraction up to 100\% of the true
value.
...
fraction of \XXXnote{GWA: FIXME} for the results shown. Given the location of

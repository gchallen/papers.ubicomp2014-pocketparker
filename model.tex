...
distribution and incorporate this new information. Figure~\ref{fig-example}
...
Figure~\ref{fig-example-arrival} shows an example of the effect of an
...
is equal to 1. Figure~\ref{fig-example-departure} shows the hole in the
...
P(t, n)$. Figure~\ref{fig-example-search} shows how the distribution shifts
...
information provided by implicit searches. We believe that this parameter
should be scaled with $\frac{1}{f_m}$, inversely with the monitored fraction.
In Section~\ref{sec-evaluation} we evaluate different values of $s$ and show
how they affect PocketParker's estimates. \XXXnote{GWA: Need to actually do
this.}

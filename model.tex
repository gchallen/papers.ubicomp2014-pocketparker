...
on streets.  We thus structure our prediction engine to answer the probability
...
assign implicit searches based upon that information plus the actual lot in

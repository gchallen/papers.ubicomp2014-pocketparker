...
desirable lots associated with the some destination. If a lot is associated
with multiple destinations, we cannot uniquely determine the destination of
the user. However, this only becomes important if the two destinations would
produce different desirability rankings or involve different lots. For
example, in Figure~\ref{fig-lots}, if lots 1~and~2

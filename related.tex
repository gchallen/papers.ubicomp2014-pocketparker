...
Nericell~\cite{Mohan:2008:NRM} uses multiple sensors to monitor road and
traffic conditions in an urban setting. Balan et al.~\cite{Balan:2011:RTI} uses
GPS devices deployed in taxi cabs to estimate taxi fare and trip duration.
StarTrack~\cite{Ananthanarayanan:2009:SFE, Haridasan:2010:SNG} provides general
abstractions for appliations that need tracking functionalities such as
recording, comparing, and querying tracks.
